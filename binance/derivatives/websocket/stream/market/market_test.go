...
func TestStream(t *testing.T) {
	...
	stream.HandleKlineStreamEvent(handleStream[*klines.KlineData](env, klines.Event))
	stream.HandleContinuousKlineStreamEvent(handleStream[*klines.KlineData](env, klines.Event))
